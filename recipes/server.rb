...
node["keystone"]["adminURL"] = identity_admin_endpoint.to_s
node["keystone"]["internalURL"] = identity_admin_endpoint.to_s
node["keystone"]["publicURL"] = identity_endpoint.to_s
